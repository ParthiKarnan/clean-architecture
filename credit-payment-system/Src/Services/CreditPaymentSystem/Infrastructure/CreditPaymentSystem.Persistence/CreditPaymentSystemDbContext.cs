...
{
    public class CreditPaymentSystemDbContext : DbContext
    {
        public CreditPaymentSystemDbContext(DbContextOptions<CreditPaymentSystemDbContext> options)
           : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(CreditPaymentSystemDbContext).Assembly);
